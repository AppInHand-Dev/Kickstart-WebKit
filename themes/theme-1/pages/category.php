...
$PageContents = load_or_cache_xml(APP_DATA_PATH . "/{$lang}/pages/categories/{$_ARG1}.xml", APP_CACHE_PATH, [
		'format' => 'php',
...
$ItemContents = load_or_cache_xmls(APP_DATA_PATH . "/{$lang}/pages/categories/{$_ARG1}", APP_CACHE_PATH, [
		'format' => 'php',
		'cachePrefix' => 'content-page',
		'parser' => function($p, SimpleXMLElement $xml) { return json_decode(json_encode($xml), true); },
		'force' => $forceCacheRegen
